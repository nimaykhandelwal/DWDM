CREATE DATABASE Healthcare_StarSchema;
USE Healthcare_StarSchema;
...
(7, 'Medanta', 'Gurgaon, Haryana', 'Sanjeev Singh'),
(8, 'Narayana Health', 'Ahmedabad, Gujarat', 'Kiran Patel'),
(9, 'Jaipur Golden Hospital', 'Jaipur, Rajasthan', 'Rajesh Chauhan'),
(10, 'PGIMER', 'Chandigarh, Chandigarh', 'Neha Malhotra');
